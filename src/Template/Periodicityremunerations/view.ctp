...
<div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Ver - <span class="semi-bold">Periodicidad de remuneracion</span></h3>
</div>
      ...
      <div class="grid simple form-grid">
        ...
        <?= $this->Form->create($periodicityremuneration) ?>
            ...
            <div class="form-group pull-right">
                <?= $this->Html->link('Regresar', ['controller' => 'Periodicityremunerations', 'action' => 'index'], ['class' => 'btn btn-info btn-cons']) ?>
            </div>
        <?= $this->Form->end() ?>
        </div>
      </div>
