 ...
 * @var \App\Model\Entity\Occupationalcategory $occupationalcategory
 */
?>
...
<ul class="breadcrumb">
    ...
    <li><?= $this->Html->link('Categorias ocupacionales', ['controller' => 'Occupationalcategories', 'action' => 'index'], ['class' => 'active']) ?></li>
</ul>
<div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Editar - <span class="semi-bold">Categoria ocupacional</span></h3>
</div>
...
<div class="row">
    <div class="col-md-12">
      <div class="grid simple form-grid">
        ...
        <?= $this->Form->create($occupationalcategory) ?>
            ...
            <div class="form-group">
                ...
                <?= $this->Html->link('Cancelar', ['controller' => 'Occupationalcategories', 'action' => 'index'], ['class' => 'btn btn-white btn-cons']) ?>
            </div>
        <?= $this->Form->end() ?>
        </div>
      </div>
