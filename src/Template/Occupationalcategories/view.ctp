...
<div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Ver - <span class="semi-bold">Categoria ocupacional</span></h3>
</div>
      ...
      <div class="grid simple form-grid">
        ...
        <?= $this->Form->create($occupationalcategory) ?>
            ...
            <div class="pull-right">
                ...
                <?= $this->Html->link('Regresar', ['controller' => 'Occupationalcategories', 'action' => 'index'], ['class' => 'btn btn-info btn-cons']) ?>
            </div>
        <?= $this->Form->end() ?>
        </div>
      </div>
