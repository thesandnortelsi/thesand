...
<div class="page-title">
    <h3>Situaciones del trabajador</h3>
</div>
<div id="container">
    ...
    <div class="span12">
      <div class="grid simple ">
        <div class="grid-title">
          <h4>Lista de <span class="semi-bold">Situaciones del trabajador</span></h4>
          ...
          <div class="tools">
            ...
            <?= $this->Html->link('<i class="material-icons">add</i>', ['controller' => 'Situations', 'action' => 'add'], ['escape' => false]) ?>
          </div>
        </div>
        <div class="grid-body ">
