    ...
    <div class="page-container row">
      ...
      <div class="page-sidebar " id="main-menu">
        ...
        <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
          ...
          <ul>
            <li class="start  open active "> <a href="#"><i class="material-icons">home</i> <span class="title">Dashboard</span> <span class="arrow open"></span></a>
              <ul class="sub-menu">
            ...
            <li>
              <a href="#"> <i class="material-icons">build</i> <span class="title">Mantenimiento</span> <span class="selected"></span><span class="arrow"></span></a>
