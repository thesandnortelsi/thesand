...
<ul class="breadcrumb">
    ...
    <li><?= $this->Html->link('Tipos de documento', ['controller' => 'Documenttypes', 'action' => 'index'], ['class' => 'active']) ?></li>
</ul>
<div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Editar - <span class="semi-bold">Tipo de documento</span></h3>
</div>
      ...
      <div class="grid simple form-grid">
        ...
        <?= $this->Form->create($documenttype) ?>
            ...
            <div class="form-group">
                ...
                <?= $this->Html->link('Cancelar', ['controller' => 'Documenttypes', 'action' => 'index'], ['class' => 'btn btn-white btn-cons']) ?>
            </div>
        <?= $this->Form->end() ?>
        </div>
      </div>
