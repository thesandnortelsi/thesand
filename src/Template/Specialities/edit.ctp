...
<ul class="breadcrumb">
  ...
  <div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Editar - <span class="semi-bold">Especialidad</span></h3>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="grid simple form-grid">
        ...
        <?= $this->Form->create($speciality) ?>
            ...
            <div class="form-group">
              <?= $this->Form->control('name', [ 'label' =>'Descripción', ' class' => 'form-control']); ?>
            </div>

            <div class="form-actions">
              <div class="pull-right">
                <?= $this->Form->button('Guardar', ['class' => 'btn btn-success btn-cons']) ?>
                <?= $this->Html->link('Cancelar', ['controller' => 'Specialities', 'action' => 'index'], ['class' => 'btn btn-white btn-cons']) ?>
