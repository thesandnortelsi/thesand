...
<ul class="breadcrumb">
    ...
    <li><?= $this->Html->link('Nacionalidades', ['controller' => 'Nationalities', 'action' => 'index'], ['class' => 'active']) ?></li>
</ul>
<div class="page-title"> <i class="icon-custom-left"></i>
    <h3>Editar - <span class="semi-bold">Nacionalidad</span></h3>
</div>
      ...
      <div class="grid simple form-grid">
        ...
        <?= $this->Form->create($nationality) ?>
            ...
            <div class="form-group">
                ...
                <?= $this->Html->link('Cancelar', ['controller' => 'Nationalities', 'action' => 'index'], ['class' => 'btn btn-white btn-cons']) ?>
            </div>
        <?= $this->Form->end() ?>
        </div>
      </div>
