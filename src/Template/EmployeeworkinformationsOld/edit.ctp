...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $employeeworkinformation->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $employeeworkinformation->id)]
            )
        ?></li>
...
<div class="employeeworkinformations form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Employeeworkinformation') ?></legend>
        <?php
            ...
            echo $this->Form->control('employeepersonalinformation_id');
        ?>
    </fieldset>
