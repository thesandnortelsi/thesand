                          ...
                          <div class="grid simple form-grid">
                            ...
                            <?= $this->Form->create($employeeworkinformation) ?>
                                ...
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">      
                                            <?=  $this->Form->control('employeepersonalinformation_id', ['options' => $employeepersonalinformations, 'label' => 'Trabajador', 'class' => 'form-control', 'disabled' => 'true']); ?>
                                        </div>
                                    </div>
                                ...
                                <div class="row form-row">
                                    <div class="col-md-4">
                                        <div class="form-group">      
                                            <?=  $this->Form->control('employeetype_id', ['options' => $employeetypes, 'label' => 'Convenio para evitar la doble tributación', 'class' => 'form-control']); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">      
                                            <?=  $this->Form->control('position_id', ['options' => $positions,  'label' => 'Tipo de planilla', 'class' => 'form-control']); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">      
                                            <?=  $this->Form->control('task_id', ['options' => $tasks, 'label' => 'Fecha de ingreso', 'class' => 'form-control']); ?>
                                        </div>
                                    </div>
                                ...
                                <div class="row form-row">
                                    <div class="col-md-4">
                                        <div class="form-group">      
                                            <?=  $this->Form->control('area_id', ['options' => $areas, 'label' => 'Convenio para evitar la doble tributación', 'class' => 'form-control']); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">      
                                            <?=  $this->Form->control('speciality_id', ['options' => $specialities,  'label' => 'Tipo de planilla', 'class' => 'form-control']); ?>
                                        </div>
                                    </div>
