 ...
 * @method \App\Model\Entity\Zonetype saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\Zonetype findOrCreate($search, callable $callback = null, $options = [])
 *
