...
class ManufacturersFixture extends TestFixture
{
    ...
    public $fields = [
        'manufacture_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['manufacture_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'state' => 'Lorem ',
                'user_created' => 1,
                'created' => '2019-06-19 15:23:14',
                'user_modified' => 1,
                'modified' => '2019-06-19 15:23:14'
            ],
        ];
        parent::init();
    }
