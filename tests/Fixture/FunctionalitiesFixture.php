...
/**
 * FunctionalitiesFixture
 */
class FunctionalitiesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        'functionality_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['functionality_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
