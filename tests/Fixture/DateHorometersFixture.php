...
/**
 * DateHorometersFixture
 */
class DateHorometersFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        'date_horometer_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['date_horometer_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'state' => 'Lorem ',
                'user_created' => 1,
                'created' => '2019-06-21 15:50:07',
                'user_modified' => 1,
                'modified' => '2019-06-21 15:50:07'
            ],
        ];
        parent::init();
    }
