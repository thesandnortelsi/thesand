...
class MachinesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'horometer' => ['type' => 'string', 'length' => 10, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'ispection' => '2019-07-01',
                'entry' => '2019-07-01',
                'horometer' => 'Lorem ip',
                'factor' => 1.5,
                'state' => 'Lorem ipsum dolor sit a',
                'user_created' => 1,
                'created' => '2019-07-01 16:21:27',
                'user_modified' => 1,
                'modified' => '2019-07-01 16:21:27'
            ],
        ];
        parent::init();
    }
