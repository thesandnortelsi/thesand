...
class MachinesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'hour_left' => ['type' => 'decimal', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'day_left' => ['type' => 'decimal', 'length' => 7, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'ispection' => '2019-07-04',
                'entry' => '2019-07-04',
                'horometer' => 1.5,
                'horometer_mantenaice' => 1.5,
                'position' => 1,
                'date_mantenaice' => '2019-07-04',
                'factor' => 1.5,
                'hour_left' => 1.5,
                'day_left' => 1.5,
                'state' => 'Lorem ipsum dolor sit a',
                'user_created' => 1,
                'created' => '2019-07-04 15:57:22',
                'user_modified' => 1,
                'modified' => '2019-07-04 15:57:22'
            ],
        ];
        parent::init();
    }
