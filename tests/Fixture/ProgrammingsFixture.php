...
class ProgrammingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'horometer_estimated' => ['type' => 'decimal', 'length' => 10, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        ...
        '_indexes' => [
            'fk_programmings_machines1_idx' => ['type' => 'index', 'columns' => ['machine_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_programmings_machines1' => ['type' => 'foreign', 'columns' => ['machine_id'], 'references' => ['machines', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'day' => 'Lo',
                'position' => 1,
                'horometer_estimated' => 1.5,
                'horometer_mantenaice' => 1.5,
                'user_created' => 1,
                'created' => '2019-07-02 20:13:24',
                'user_modified' => 1,
                'modified' => '2019-07-02 20:13:24'
            ],
        ];
        parent::init();
    }
