 ...
 * NightsFixture
 */
class NightsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        'night_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['night_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
