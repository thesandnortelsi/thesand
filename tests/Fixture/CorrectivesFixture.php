 ...
 * CorrectivesFixture
 */
class CorrectivesFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_correctives_machines1_idx' => ['type' => 'index', 'columns' => ['machine_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['int'], 'length' => []],
            'fk_correctives_machines1' => ['type' => 'foreign', 'columns' => ['machine_id'], 'references' => ['machines', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'day' => 'Lo',
                'user_created' => 1,
                'created' => '2019-07-08 17:29:42',
                'user_modified' => 1,
                'modified' => '2019-07-08 17:29:42'
            ],
        ];
        parent::init();
    }
