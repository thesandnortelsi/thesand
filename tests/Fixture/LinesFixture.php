...
class LinesFixture extends TestFixture
{
    ...
    public $fields = [
        'line_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['line_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'state' => 'Lorem ',
                'user_created' => 1,
                'created' => '2019-06-19 15:33:21',
                'user_modified' => 1,
                'datetime' => '2019-06-19 15:33:21'
            ],
        ];
        parent::init();
    }
