...
class EmployeepersonalinformationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ubigeos_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'fk_persons_nationalities1_idx' => ['type' => 'index', 'columns' => ['nationality_id'], 'length' => []],
            'fk_persons_documenttypes1_idx' => ['type' => 'index', 'columns' => ['documenttype_id'], 'length' => []],
            'fk_persons_sendingcountries21_idx' => ['type' => 'index', 'columns' => ['sendingcountry_id'], 'length' => []],
            'fk_persons_streettypes21_idx' => ['type' => 'index', 'columns' => ['streettype_id'], 'length' => []],
            'fk_persons_zonetypes1_idx' => ['type' => 'index', 'columns' => ['zonetype_id'], 'length' => []],
            'fk_employeepersonalinformations_ubigeos1_idx' => ['type' => 'index', 'columns' => ['ubigeos_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_employeepersonalinformations_ubigeos1' => ['type' => 'foreign', 'columns' => ['ubigeos_id'], 'references' => ['ubigeos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'state' => 'Lorem ',
                'user_created' => 1,
                'created' => '2019-07-10 17:20:04',
                'user_modified' => 1,
                'modified' => '2019-07-10 17:20:04',
                'nationality_id' => 1,
                'sendingcountry_id' => 1,
                'streettype_id' => 1,
                'zonetype_id' => 1,
