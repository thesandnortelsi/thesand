...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_usuario_persona1_idx' => ['type' => 'index', 'columns' => ['person_id'], 'length' => []],
            'fk_users_rols1_idx' => ['type' => 'index', 'columns' => ['rol_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['user_id'], 'length' => []],
            'fk_users_rols1' => ['type' => 'foreign', 'columns' => ['rol_id'], 'references' => ['rols', 'rol_id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_usuario_persona1' => ['type' => 'foreign', 'columns' => ['person_id'], 'references' => ['persons', 'person_id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'state' => 'Lorem ',
                'user_created' => 1,
                'created' => '2019-06-06 22:17:58',
                'user_modified' => 1,
                'modified' => '2019-06-06 22:17:58'
            ],
        ];
        parent::init();
    }
