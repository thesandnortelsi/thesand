...
class NationalitiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'code_sunat' => ['type' => 'string', 'length' => 4, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_created' => 1,
                'created' => '2019-07-07 15:04:35',
                'user_modified' => 1,
                'modified' => '2019-07-07 15:04:35'
            ],
        ];
        parent::init();
    }
