...
class EmployeesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            ...
            'fk_employees_persons1' => ['type' => 'index', 'columns' => ['person_id'], 'length' => []],
        ...
        '_constraints' => [
            ...
            'fk_employees_persons1' => ['type' => 'foreign', 'columns' => ['person_id'], 'references' => ['persons', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'payrolltype_id' => 1,
                'admission_date' => '2019-07-04',
                'state' => 1,
                'liquidation_date' => '2019-07-04',
                'liquidation_reason' => 'Lorem ipsum dolor sit amet',
                'user_created' => 1,
                'created' => '2019-07-04 22:14:25',
                'user_modified' => 1,
                'modified' => '2019-07-04 22:14:25',
                'person_id' => 1,
                'proyect_id' => 1,
                'employeetype_id' => 1
            ],
